...
},{"./checkPropTypes":29,"./lib/ReactPropTypesSecret":33,"_process":28,"object-assign":27}],32:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./wrapMapToProps":45,"redux":57}],41:[function(require,module,exports){
'use strict';
...
},{"_process":28,"symbol-observable":58}],58:[function(require,module,exports){
(function (global){
'use strict';
...
var update = function update(signal, key, value) {
  return {
...
var comboboxInfoArrive = function comboboxInfoArrive(data) {
  return {
...
var USER_INPUT_SIGNAL = exports.USER_INPUT_SIGNAL = 'User input is comming';

var BANK_FIELD = exports.BANK_FIELD = "bank";
var PRODUCT_FIELD = exports.PRODUCT_FIELD = "product";
var PAYOUT_DATE_FIELD = exports.PAYOUT_DATE_FIELD = "payoutDate";
var ETP_FIELD = exports.ETP_FIELD = "etpFeasibility";
var VIOLATION_FIELD = exports.VIOLATION_FIELD = "violationMinimalRequirement";
var FOREIGN_SURCHARGE_FIELD = exports.FOREIGN_SURCHARGE_FIELD = "foreignSurcharge";
var COUNTRY_FIELD = exports.COUNTRY_FIELD = "country";
var SEGMENT_FIELD = exports.SEGMENT_FIELD = "segment";
var BUSINESS_FIELD = exports.BUSINESS_FIELD = "business";
var CONTRIBUTION_MARGIN_FIELD = exports.CONTRIBUTION_MARGIN_FIELD = "contributionMargin";
var BUSINESS_CASE_FIELD = exports.BUSINESS_CASE_FIELD = "businessCase";
var PROPERTY_FIELD = exports.PROPERTY_FIELD = "typeOfProperty";
var AMOUNT_FIELD = exports.AMOUNT_FIELD = "amount";
var MARKET_VALUE_FIELD = exports.MARKET_VALUE_FIELD = "marketValue";
var MORTGAGE_AMOUNT_FIELD = exports.MORTGAGE_AMOUNT_FIELD = "mortgageAmount";
var RATING_FIELD = exports.RATING_FIELD = "rating";
var RAING_AGENCY_FIELD = exports.RAING_AGENCY_FIELD = "ratingAgency";
...
var StaticStore = function StaticStore() {
  ...
  this.initStore = function (data) {
    if ("object" === (typeof data === "undefined" ? "undefined" : _typeof(data))) _this.store = data;else throw new Error('Only accept object or array as input!');
  };
};
...
var InputBlock = function (_React$Component) {
  _inherits(InputBlock, _React$Component);
  ...
  function InputBlock() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InputBlock.__proto__ || Object.getPrototypeOf(InputBlock)).call.apply(_ref, [this].concat(args))), _this), _this.render = function () {
      var _this$props = _this.props,
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
      ...
      if (!_this.props.isReady) return _react2.default.createElement('div', { className: 'ic-loading' });

      var products = _StaticStore2.default.getStore()['product'];
...
var IsReady = function IsReady() {
  ...
  if (action.type === _action.COMBOBOX_INFO_ARRIVED) {
    _StaticStore2.default.initStore(action.payload);
    return true;
  }
  return state;
};
...
var _IsReady = require('./IsReady');

var _IsReady2 = _interopRequireDefault(_IsReady);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({
  userInput: _UserInput2.default,
  isReady: _IsReady2.default
});
